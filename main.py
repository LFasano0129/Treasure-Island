...
while not win:
    ...
    *******************************************************************************
    ...
    path_choice = input('Which path do you choose? "left" or "right"?\n').lower()
    if path_choice.strip() == "right":
        print("You enter the path through the right and it caves in on top of you")
        print("YOU DIED :(")
    elif path_choice.strip() == "left":
